...
Blockly.Blocks['servo_2wheels_init'] = {  init: function() {
    ...
    //this.appendDummyInput()	.appendField(Blockly.Msg.left).setAlign(Blockly.ALIGN_RIGHT)	.appendField(new Blockly.FieldDropdown(profile[card].dropdownAllPins), "PINL1");
   // this.appendDummyInput()	.appendField(Blockly.Msg.right).setAlign(Blockly.ALIGN_RIGHT)	.appendField(new Blockly.FieldDropdown(profile[card].dropdownAllPins), "PINR2");
    this.setInputsInline(true);
...
Blockly.Arduino['servo_2wheels_init'] = function(block) {
    ...
    var pinl1 = block.getFieldValue('PINL1');
    var pinr2 = block.getFieldValue('PINR2');

    Blockly.Arduino.includes_['otto9_wheels'] =  'const int pinl = 13;\n'
    + 'const int pinr = 14; \n'
    + 'const int pinl1 = 27;\n'
    + 'const int pinr2 = 26;\n';  // Using 2 motors for both directions


Blockly.Arduino.setups_['otto9_initw'] = 
    'pinMode(pinl, OUTPUT);\n'
    + 'pinMode(pinr, OUTPUT);\n'
